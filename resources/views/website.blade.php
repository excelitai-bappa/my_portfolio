...
<!-- Mirrored from solonick.kwst.net/site/index4.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Sep 2021 02:42:53 GMT -->
<head>
        <!--=============== basic  ===============-->
        <meta charset="UTF-8">
        ...
        <!--=============== css  ===============-->
        <link type="text/css" rel="stylesheet" href="{{asset('assets/frontend_assets/css/reset.css')}}">
        <link type="text/css" rel="stylesheet" href="{{asset('assets/frontend_assets/css/plugins.css')}}">
        <link type="text/css" rel="stylesheet" href="{{asset('assets/frontend_assets/css/style.css')}}">
        <link type="text/css" rel="stylesheet" href="{{asset('assets/frontend_assets/css/color.css')}}">
        <!--=============== favicons ===============-->
        <link rel="shortcut icon" href="{{asset('assets/frontend_assets/images/favicon.ico')}}">
    </head>
    <body>
        <!--loader-->
        ...
        <div id="main">
            ...
            <div class="nav-holder">
                <a class="header-logo" href="index.html"><img src="{{asset('assets/frontend_assets/images/logo2.png')}}" alt=""></a> 
                ...
                <div class="hero-wrap" id="sec1" data-scrollax-parent="true">
                    ...
                    <div class="hero-inner fl-wrap full-height">
                        <div class="half-hero-wrap">
                            <h1>Hey there!<br>I'm Bappa Sutradhar<br>Independent <span> Web Developer</span></h1>
                        ...
                        <div class="bg"  data-bg="images/bg/28.jpg" data-scrollax="properties: { translateY: '250px' }" ></div>
                            ...
                            <div class="custom-inner-holder  mar-bottom">
                                ...
                                <div class="custom-inner">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4"><img src="images/all/4.jpg" class="respimg" data-scrollax="properties: { translateY: '-170px' }" alt=""></div>
                                        <div class="col-md-4">
                                ...
                                <div class="custom-inner">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3"><img src="images/all/8.jpg" class="respimg" data-scrollax="properties: { translateY: '270px' }" alt=""></div>
                                    </div>
                                </div>
                                <!-- custom-inner end -->
                                <!-- custom-inner -->
                                ...
                                <div class="custom-inner">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4"><img src="images/all/6.jpg" class="respimg" data-scrollax="properties: { translateY: '100px' }" alt=""></div>
                                        <div class="col-md-4">
                                            <div class="custom-inner-content fl-wrap">
                                                <h4>Complete the project "domik"</h4>
                                                <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. </p>
                        ...
                        <div class="slider-carousel-wrap fl-wrap">
                            ...
                            <div class="fet_pr-carousel cur_carousel-slider-container fl-wrap">
                                ...
                                <div class="slick-item">
                                    <div class="fet_pr-carousel-box">
                                        <div class="fet_pr-carousel-box-media fl-wrap">
                                            <img src="images/folio/web/slider/3.jpg" class="respimg" alt="">
                                            <a href="images/folio/web/slider/3.jpg" class="fet_pr-carousel-box-media-zoom   image-popup"><i class="fal fa-search"></i></a>
                                        </div>
                                ...
                                <div class="slick-item">
                                    <div class="fet_pr-carousel-box">
                                        <div class="fet_pr-carousel-box-media fl-wrap">
                                            <img src="images/folio/web/slider/4.jpg" class="respimg" alt="">
                                ...
                                <div class="slick-item">
                                    <div class="fet_pr-carousel-box">
                                        <div class="fet_pr-carousel-box-media fl-wrap">
                                            <img src="images/folio/web/slider/2.jpg" class="respimg" alt="">
                                            <a href="images/folio/web/slider/2.jpg" class="fet_pr-carousel-box-media-zoom   image-popup"><i class="fal fa-search"></i></a>
                                        </div>
                                        <div class="fet_pr-carousel-box-text fl-wrap">
                                ...
                                <div class="slick-item">
                                    <div class="fet_pr-carousel-box">
                                        <div class="fet_pr-carousel-box-media fl-wrap">
                                            <img src="images/folio/web/slider/5.jpg" class="respimg" alt="">
                                            <a href="images/folio/web/slider/5.jpg" class="fet_pr-carousel-box-media-zoom   image-popup"><i class="fal fa-search"></i></a>
                                        </div>
                                        <div class="fet_pr-carousel-box-text fl-wrap">
        ...
        <!-- Main end -->
        <!--=============== scripts  ===============-->
        <script type="text/javascript" src="{{asset('assets/frontend_assets/js/jquery.min.js')}}"></script>
        <script type="text/javascript" src="{{asset('assets/frontend_assets/js/plugins.js')}}"></script>
        <script type="text/javascript" src="{{asset('assets/frontend_assets/js/scripts.js')}}"></script>
    </body>

<!-- Mirrored from solonick.kwst.net/site/index4.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Sep 2021 02:43:54 GMT -->
</html>