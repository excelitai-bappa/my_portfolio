...
<html lang="en" dir="ltr">
	<head>
		...
		<!--Sidemenu css -->
       <link href="{{asset('assets/backend_assets/css/sidemenu.css')}}" rel="stylesheet">

		<!-- P-scroll bar css-->
		<link href="{{asset('assets/backend_assets/plugins/p-scrollbar/p-scrollbar.css')}}" rel="stylesheet" />

		<!---Icons css-->
		<link href="{{asset('assets/backend_assets/css/icons.css')}}" rel="stylesheet" />

		<!-- Simplebar css -->
		<link rel="stylesheet" href="{{asset('assets/backend_assets/plugins/simplebar/css/simplebar.css')}}">

		<!-- INTERNAL Select2 css -->
		<link href="{{asset('assets/backend_assets/plugins/select2/select2.min.css')}}" rel="stylesheet" />
	...
	<body class="app sidebar-mini  dark-mode">
		...
		<div id="global-loader" >
			<img src="{{asset('assets/backend_assets/images/svgs/loader.svg')}}" alt="loader">
		</div>
		<!--- End Global-loader-->
				...
				<aside class="app-sidebar">
					<div class="app-sidebar__logo">
						<a class="header-brand brand-5" href="index.html">
							<img src="{{asset('assets/backend_assets/images/brand/logo.png')}}" class="header-brand-img desktop-lgo" alt="Admitro logo">
							<img src="{{asset('assets/backend_assets/images/brand/logo1.png')}}" class="header-brand-img dark-logo" alt="Admitro logo">
							<img src="{{asset('assets/backend_assets/images/brand/favicon.png')}}" class="header-brand-img mobile-logo" alt="Admitro logo">
							<img src="{{asset('assets/backend_assets/images/brand/favicon1.png')}}" class="header-brand-img darkmobile-logo" alt="Admitro logo">
						</a>
					</div>

					<div class="app-sidebar__user" style="padding: 0px!important;"></div>
					...
					<div class="side-app">
						...
						<div class="app-header header top-header">
							<div class="container-fluid">
								<div class="d-flex">
									<a class="header-brand brand-5" href="index.html">
										<img src="../../assets/images/brand/logo.png" class="header-brand-img desktop-lgo" alt="Admitro logo">
										<img src="../../assets/images/brand/logo1.png" class="header-brand-img dark-logo" alt="Admitro logo">
										<img src="../../assets/images/brand/favicon.png" class="header-brand-img mobile-logo" alt="Admitro logo">
										<img src="../../assets/images/brand/favicon1.png" class="header-brand-img darkmobile-logo" alt="Admitro logo">
									</a>
									...
									<div class="card-body">
											...
											<div class="row align-items-center">
												<div class="col-9 col-sm-9">
													<div class="media mt-0">
														<img src="../../assets/images/users/1.jpg" alt="img" class="avatar brround avatar-md mr-3">
										...
										<div class="list-card">
											...
											<div class="row align-items-center">
												<div class="col-9 col-sm-9">
													<div class="media mt-0">
														<img src="../../assets/images/users/9.jpg" alt="img" class="avatar brround avatar-md mr-3">
														<div class="media-body">
															<div class="d-md-flex align-items-center mt-1">
										...
										<div class="list-card">
											...
											<div class="row align-items-center">
												<div class="col-9 col-sm-9">
													<div class="media mt-0">
														<img src="../../assets/images/users/2.jpg" alt="img" class="avatar brround avatar-md mr-3">
														<div class="media-body">
															<div class="d-md-flex align-items-center mt-1">
										...
										<div class="list-card">
											...
											<div class="row align-items-center">
												<div class="col-9 col-sm-9">
													<div class="media mt-0">
														<img src="../../assets/images/users/11.jpg" alt="img" class="avatar brround avatar-md mr-3">
														<div class="media-body">
															<div class="d-md-flex align-items-center mt-1">
										...
										<div class="list-card">
											...
											<div class="row align-items-center">
												<div class="col-9 col-sm-9">
													<div class="media mt-0">
														<img src="../../assets/images/users/3.jpg" alt="img" class="avatar brround avatar-md mr-3">
														<div class="media-body">
															<div class="d-md-flex align-items-center mt-1">
																<h6 class="mb-1">Joseph Abraham</h6>
															</div>
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="country-card">
											<div class="mb-5">
												<div class="d-flex">
													<span class=""><img src="../../assets/images/flags/us.svg" class="w-5 h-5 mr-2" alt="">United States</span>
											...
											<div class="mb-5">
												<div class="d-flex">
													<span class=""><img src="../../assets/images/flags/in.svg" class="w-5 h-5 mr-2" alt="">India</span>
											...
											<div class="mb-5">
												<div class="d-flex">
													<span class=""><img src="../../assets/images/flags/ru.svg" class="w-5 h-5 mr-2" alt="">Russia</span>
											...
											<div class="mb-5">
												<div class="d-flex">
													<span class=""><img src="../../assets/images/flags/ca.svg" class="w-5 h-5 mr-2" alt="">Canada</span>
											...
											<div class="mb-5">
												<div class="d-flex">
													<span class=""><img src="../../assets/images/flags/ge.svg" class="w-5 h-5 mr-2" alt="">Germany</span>
											...
											<div class="mb-5">
												<div class="d-flex">
													<span class=""><img src="../../assets/images/flags/br.svg" class="w-5 h-5 mr-2" alt="">Brazil</span>
											...
											<div class="mb-0">
												<div class="d-flex">
													<span class=""><img src="../../assets/images/flags/au.svg" class="w-5 h-5 mr-2" alt="">Australia</span>
										...
										<div class="table-responsive">
											<table class="table table-vcenter text-nowrap mb-0 table-striped table-bordered border-top">
												...
												<tbody>
													...
													<tr>
														<td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3" src="../../assets/images/orders/8.jpg" alt="media1"> New Bowl</td>
													...
													<tr>
														<td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3" src="../../assets/images/orders/9.jpg" alt="media1"> Modal Car</td>
													...
													<tr>
														<td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3" src="../../assets/images/orders/10.jpg" alt="media1"> Headset</td>
													...
													<tr>
														<td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3" src="../../assets/images/orders/12.jpg" alt="media1"> Watch</td>
													...
													<tr class="mb-0">
														<td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3" src="../../assets/images/orders/11.jpg" alt="media1"> New EarPhones</td>
		...
		<!--Sidemenu js-->
		<script src="{{asset('assets/backend_assets/plugins/sidemenu/sidemenu.js')}}"></script>

		<!-- P-scroll js-->
		<script src="{{asset('assets/backend_assets/plugins/p-scrollbar/p-scrollbar.js')}}"></script>
		<script src="{{asset('assets/backend_assets/plugins/p-scrollbar/p-scroll1.js')}}"></script>
		<script src="{{asset('assets/backend_assets/plugins/p-scrollbar/p-scroll.js')}}"></script>

		<!--INTERNAL Peitychart js-->
		<script src="{{asset('assets/backend_assets/plugins/peitychart/jquery.peity.min.js')}}"></script>
		<script src="{{asset('assets/backend_assets/plugins/peitychart/peitychart.init.js')}}"></script>

		<!--INTERNAL Apexchart js-->
		<script src="{{asset('assets/backend_assets/js/apexcharts.js')}}"></script>

		<!--INTERNAL ECharts js-->
		<script src="{{asset('assets/backend_assets/plugins/echarts/echarts.js')}}"></script>

		<!--INTERNAL Chart js -->
		<script src="{{asset('assets/backend_assets/plugins/chart/chart.bundle.js')}}"></script>
		<script src="{{asset('assets/backend_assets/plugins/chart/utils.js')}}"></script>

		<!-- INTERNAL Select2 js -->
		<script src="{{asset('assets/backend_assets/plugins/select2/select2.full.min.js')}}"></script>
		<script src="{{asset('assets/backend_assets/js/select2.js')}}"></script>

		<!--INTERNAL Moment js-->
		<script src="{{asset('assets/backend_assets/plugins/moment/moment.js')}}"></script>

		<!--INTERNAL Index js-->
		<script src="{{asset('assets/backend_assets/js/index1.js')}}"></script>

		<!-- Simplebar JS -->
		<script src="{{asset('assets/backend_assets/plugins/simplebar/js/simplebar.min.js')}}"></script>
